...
export const companyData = {
  home: {
    ...
    introduction: {
      paragraph1: "Алма Кем Трейд ХХК бол уул уурхай, боловсруулах болон аж үйлдвэрийн салбарт шаардлагатай химийн бодисуудыг олон улсын найдвартай үйлдвэрлэгчдээс шууд импортолж, Монголын зах зээлд найдвартай нийлүүлдэг худалдааны компани юм.",
  ...
  about: {
    history: "Бид олон улсын үйлдвэрлэгчдтэй шууд хамтын ажиллагаа тогтоож, Монголын нөхцөлд тохирсон оновчтой нийлүүлэлтийн шийдлийг хэрэгжүүлсэн. Удахгүй Алма Кем Трейд ХХК нь уул уурхай болон боловсруулах салбарын найдвартай, урт хугацааны түнш болох зорилготой.",
  ...
  news: [
    {
      id: 1,
      title: "Алма Кем Трейд ХХК компани шинэ химийн бүтээгдэхүүнүүдийг зах зээлд нэвтрүүлж байна",
