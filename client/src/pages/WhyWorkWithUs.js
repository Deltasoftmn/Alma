...
const content = {
  ...
  mn: {
    title: 'Яагаад бидэнтэй хамтран ажиллах вэ ?',
    ...
    features: [
      ...
      {
        title: 'Хөдөлмөрийн аюулгүй байдал',
        text: 'Бид олон улсын аюулгүй байдлын стандартыг мөрдөж, химийн бодистой ажиллах сургалт үзүүлж, бүх ажилтнууд тогтмол сургалтад хамрагдах нөхцөлөөр хангадаг.',
        icon: <Users size={24} />
      },
      {
