...
const benefitsMn = [
  ...
  { icon: <CheckCircle2 size={22} />, title: 'Өндөр цэвэршилт ба чанар', text: 'Олон улсын стандартад нийцсэн тул өндөр цэвэршилттэй, тогтвортой, найдвартай чанарыг санал болгож байна.' },
  { icon: <ShieldCheck size={22} />, title: 'Үйлдвэрлэлийн батлагдсан гүйцэтгэл', text: 'Дэлхий даяар хүлээн зөвшөөрөгдсөн бүтээгдэхүүнүүд маань уул уурхай, боловсруулах үйлдвэрт тогтмол өндөр үр ашиг, найдвартай ажиллагааг бий болгоно.' },
