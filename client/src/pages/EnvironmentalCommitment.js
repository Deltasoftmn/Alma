...
const content = {
  ...
  mn: {
    ...
    blocks: [
      {
        icon: <FishSymbol size={38} />,
        text: "Alma Chem Trade LLC нь 'Chuluut Tul' байгаль орчны төслийг дэмжин ажиллаж, Чулуутын хөндийг хамгаалах, Монголын уугуул хуучо таймен загасыг хадгалахад хувь нэмэр оруулж байна. Хамтрагчид судалгаа, загас үржүүлэг, нутагшуулах ажил хэрэгжүүлж, уугуул загасны нөөцийг сэргээдэг. Эдгээр үйл ажиллагааны хүрээнд Алтайн мөрний цутгалуудад 2.23 сая цаана, цурхай загасны үр төл амжилттай нутагшуулж, экосистемийн сэргэлт, урт хугацааны биологийн олон янз байдлын хамгаалалтад чухал дэмжлэг үзүүлэв." 
      },
      {
        icon: <TreePine size={38} />,
