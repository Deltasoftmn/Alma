...
function Home() {
  ...
  const content = {
    mn: {
      title: homeData?.title || "Алма Кем Трейд ХХК",
      ...
      introParagraph: homeData?.introduction?.paragraph1 || "Алма Кем Трейд ХХК бол уул уурхай, боловсруулах болон аж үйлдвэрийн салбарт шаардлагатай химийн бодисуудыг олон улсын найдвартай үйлдвэрлэгчдээс шууд импортолж, Монголын зах зээлд найдвартай нийлүүлдэг худалдааны компани юм.",
